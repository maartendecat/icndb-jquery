...
$.icndb.client.id=4;$.icndb.client.version=0.1;var base="//api.icndb.com/";var full=function(resource){return base+resource+'?client='+$.icndb.client.id+'&clientVersion='+$.icndb.client.version;};var callServer=function(destination,successCB,errorCB){$.ajax({url:destination,dataType:"jsonp",type:"GET",success:function(result){successCB(result);}});}
